...
hereditary = media.Movie("Hereditary",
                         "After the family matriarch passes away, a \
                         grieving family is haunted by tragic and \
                         disturbing occurrences, and begin to unravel \
                         dark secrets.",
                         "https://upload.wikimedia.org/wikipedia/en/d/d9/Hereditary.png",  # NOQA
...
black_panther = media.Movie("Black Panther",
                            "T'Challa, heir to the hidden but advanced \
                            kingdom of Wakanda, must step forward to lead \
                            his people into a new future and must confront \
...
the_greatest_showman = media.Movie("The Greatest Showman",
                                   "Celebrates the birth of show business,\
                                    and tells of a visionary who rose from \
                                    nothing to create a spectacle that\
                                    became a worldwide sensation.",
                                   "https://upload.wikimedia.org/wikipedia/en/1/10/The_Greatest_Showman_poster.png",  # NOQA
                                   "https://www.youtube.com/watch?v=AXCTMGYUg9A")  # NOQA

searching = media.Movie("Searching",
                        "After his 16-year-old daughter goes missing, a \
                        desperate father breaks into her laptop to look for \
                        clues to find her.",
                        "https://upload.wikimedia.org/wikipedia/en/b/b8/Searching.png",  # NOQA
...
bohemian_rhapsody = media.Movie("Bohemian Rhapsody",
                                "A chronicle of the years leading up to\
                                 ...
                                 Aid (1985) concert.",
                                "https://upload.wikimedia.org/wikipedia/en/2/2e/Bohemian_Rhapsody_poster.png",  # NOQA
                                "https://www.youtube.com/watch?v=mP0VHJYFOAU")

it = media.Movie("It",
                 "In the summer of 1989, a group of bullied kids band \
                 together to destroy a shapeshifting monster, which \
                 disguises itself as a clown and preys on the children \
...
mission_impossible_fallout = media.Movie("Mission: Impossible - Fallout",
                                         "Ethan Hunt and his IMF team, along\
                                          with some familiar allies, race \
                                          against time after a mission gone\
                                           wrong.",
                                         "https://upload.wikimedia.org/wikipedia/en/f/ff/MI_–_Fallout.jpg",  # NOQA
                                         "https://www.youtube.com/watch?v=wb49-oV0F78")  # NOQA
...
oceans_eleven = media.Movie("Ocean's Eleven",
                            ...
                            "https://upload.wikimedia.org/wikipedia/en/thumb/6/68/Ocean%27s_Eleven_2001_Poster.jpg/220px-Ocean%27s_Eleven_2001_Poster.jpg",  # NOQA
...
the_dark_knight = media.Movie("The Dark Knight",
                              ...
                              from his mysterious past, he wreaks havoc and\
                               chaos on the people of Gotham. The Dark \
                               Knight must accept one of the greatest \
                               psychological and physical tests of his \
...
spirited_away = media.Movie("Spirited Away",
                            ...
                            "https://upload.wikimedia.org/wikipedia/en/thumb/d/db/Spirited_Away_Japanese_poster.png/220px-Spirited_Away_Japanese_poster.png",  # NOQA
...
life_is_beautiful = media.Movie("Life Is Beautiful",
                                ...
                                his son become victims of the Holocaust, he\
                                 uses a perfect mixture of will, humor, and \
                                 imagination to protect his son from the \
...
the_lion_king = media.Movie("The Lion King",
                            "A Lion cub crown prince is tricked by a \
                            treacherous uncle into thinking he caused his \
                            father's death and flees into exile in despair,\
                             only to learn in adulthood his identity and \
...
gravity = media.Movie("Gravity",
                      ...
                      accident which leaves them stranded in space.",
...
wall_e = media.Movie("WALL.E",
                     ...
                     "https://upload.wikimedia.org/wikipedia/en/thumb/c/c2/WALL-Eposter.jpg/220px-WALL-Eposter.jpg",  # NOQA
...
to_kill_a_mockingbird = media.Movie("To Kill a Mockingbird",
                                    ...
                                    "https://upload.wikimedia.org/wikipedia/en/thumb/8/8e/To_Kill_a_Mockingbird_poster.jpg/220px-To_Kill_a_Mockingbird_poster.jpg",  # NOQA
                                    "https://www.youtube.com/watch?v=KR7loA_oziY")  # NOQA

monty_python_and_the_holy_grail = media.Movie("Monty Python and the Holy \
                                               Grail",
                                              "King Arthur and his Knights \
                                              of the Round Table embark on a\
                                               surreal, low-budget search \
                                               for the Holy Grail, \
                                               encountering many, very silly\
                                                obstacles.",
                                              "https://upload.wikimedia.org/wikipedia/en/thumb/0/08/Monty-Python-1975-poster.png/220px-Monty-Python-1975-poster.png",  # NOQA
                                              "https://www.youtube.com/watch?v=urRkGvhXc8w")  # NOQA

room = media.Movie("Room",
                   "Held captive for years in an enclosed space, a woman and\
                    her young son finally gain their freedom, allowing the \
                    boy to experience the outside world for the first time.",
                   "https://upload.wikimedia.org/wikipedia/en/c/c2/Room_%282015_film%29.png",  # NOQA
                   "https://www.youtube.com/watch?v=E_Ci-pAL4eE")

movies = [hereditary, avengers_infinity_war, black_panther,
          the_greatest_showman, searching, bohemian_rhapsody, it,
          the_shawshank_redemption, mission_impossible_fallout,
          oceans_eleven, the_dark_knight, spirited_away, inception,
          life_is_beautiful, interstellar, the_lion_king, gravity, wall_e,
